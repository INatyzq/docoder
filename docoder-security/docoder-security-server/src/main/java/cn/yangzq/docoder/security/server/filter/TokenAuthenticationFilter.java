package cn.yangzq.docoder.security.server.filter;

import cn.yangzq.docoder.security.server.handler.AuthenticationProvider;
import cn.yangzq.docoder.security.server.handler.UnauthorizedEntryPoint;
...
public class TokenAuthenticationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
        ...
        try {
            ...
            unauthorizedEntryPoint.setException(e);
