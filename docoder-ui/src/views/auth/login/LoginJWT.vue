<template>
  <div>
    ...
    <div class="flex flex-wrap justify-between mb-3">
      ...
      <vs-button :disabled="!validateForm" @click="loginJWT">登录
        <vs-icon icon-pack="feather" icon="icon icon-arrow-right"></vs-icon>
      </vs-button>
    </div>
    ...
    <div class="social-login-buttons flex flex-wrap items-center mt-4">
      ...
      <div class="bg-twitter pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4">
        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter"
             class="text-white h-4 w-4 svg-inline--fa fa-twitter fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 512 512">
          <path fill="currentColor"
      ...
      <div class="bg-google pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4">
        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google"
             class="text-white h-4 w-4 svg-inline--fa fa-google fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 488 512">
          <path fill="currentColor"
