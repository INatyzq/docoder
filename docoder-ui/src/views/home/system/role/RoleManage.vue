...
<script>
    ...
    import RoleCellRendererActions from "./RoleCellRendererActions.vue";

    export default {
        components: {PermissionConfig, BaseGrid,RoleCellRendererActions},
        extends: BaseGrid,
        data() {
            return {
                that:this,
        ...
        methods: {
            ...
            getListPage() {
                this.$vs.loading();
                let that = this;
                getRequest('/system/sysRole/listPage', this.queryHelper.getParams()).then(function (res) {
                    if (res.success) {
            ...
            saveData() {
                ...
                this.$vs.loading();
                let that = this;
                postRequest('/system/sysRole/batch', allData).then(function (res) {
                    if (res.success) {
                        that.getListPage();
